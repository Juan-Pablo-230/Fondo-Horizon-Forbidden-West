# Fondo-Horizon-Zero-Dawn

# Español:
El mod solo funciona en Opera GX, las formas de instalación son 2:

1) Mediante la [store de Opera](https://store.gx.me/mods/pzehs8/fondo-horizon-forbidden-west/) le das al botón de "Instale" y el mod estará funcionando. Esta es la versión estable y la que menos problemas contiene.
...
1) Via the [Opera store](https://store.gx.me/mods/pzehs8/fondo-horizon-forbidden-west/). Click the "Install" button and the mod will be working. This is the stable version and the one with the fewest issues.
